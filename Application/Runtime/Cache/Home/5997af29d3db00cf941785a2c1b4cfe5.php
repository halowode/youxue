        ...
        <div class="logo_ccon1">
            ...
            <div class="logo_enter1" style="border:none;float:left;">
                ...
                <div class="login_box1 form-group">
                    ...
                    <input class="use_name form-control" name='cname'  type="text" placeholder="合同内容名称" /><font style="color:#FF0000;line-height:40px;">&nbsp;</font>
                </div>
                <div class="login_box1 form-group">
                    <span class="login_title1 col-sm-2 control-label" >客户名称</span>
                    <input class="use_name form-control" id="gname" name='gname'  type="text" placeholder="请与发票名称保持一致（全称）" /><font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="login_box1 form-group">
                ...
                <div class="login_box1 form-group">
                    ...
                    <select class="use_name form-control input-sm" name="checkuid"  style="width:200px">
                        <?php if(is_array($cuser)): foreach($cuser as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" > <?php echo ($vo["username"]); ?></option><?php endforeach; endif; ?>
                    </select>
                    <font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="login_box1 form-group">
                    ...
                    <select class="use_name form-control input-sm" name="exuid"  style="width:200px">
                        <?php if(is_array($exuser)): foreach($exuser as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" > <?php echo ($vo["username"]); ?></option><?php endforeach; endif; ?>
                    </select>
                    <font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="login_box1 form-group" id="ctotals">
                    <span class="login_title1 col-sm-2 control-label" >合同金额</span>
                    <input class="use_name form-control" id="total" name='total'  type="text" placeholder="合同分配金额" /><font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="login_box1 form-group">
                ...
                <div class="login_box1 form-group  daniel_hide" style="width:90%">
                    ...
                    <input type="file" id="propic1" /><span id="icon_img" style="margin-left: 160px"></span><span style="color:red"></span>
                </div>
                <div class="login_box1 form-group  daniel_hide" style="width:90%">
                    <span class="login_title1 col-sm-2 control-label">相关图片</span>
                    <input type="file" id="propic2" /><span id="icon_img2" style="margin-left: 160px"></span><span style="color:red"></span>
                </div>
                <div class="login_box1 form-group  daniel_hide" style="width:90%">
                    <span class="login_title1 col-sm-2 control-label">相关图片</span>
                    <input type="file" id="propic3" /><span id="icon_img3" style="margin-left: 160px"></span><span style="color:red"></span>
                </div>
