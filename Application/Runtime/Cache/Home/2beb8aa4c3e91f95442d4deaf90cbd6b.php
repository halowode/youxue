...
<span class="cp_title" >确认初审</span>
<div class="table_con">
    <form method="get" action="">
        <table cellpadding="0" cellspacing="1">
            <tr>
                <td width="5%" align="center" class="tb_title">报销单号</td>
                <td width="5%" align="center" class="tb_title">报销项目</td>
                <td width="8%" align="center" class="tb_title">申请ID</td>
            ...
            <?php if(!empty($data['list'])): if(is_array($data['list'])): foreach($data['list'] as $key=>$vo): ?><tr>
                        <td align="center"><a href="<?php echo U("detail?id=$vo[id]");?>"><?php echo ($vo["rbno"]); ?></a></td>
                        <td align="center"><?php echo ($vo["pname"]); ?></td>
                        <td align="center"><?php echo ($vo["id"]); ?></td>
                        <td align="center"><?php echo ($vo["scno"]); ?></td>
                        <td align="center"><?php echo ($vo["cgcno"]); ?></td>
                        <td align="center"><?php echo ($vo["uname"]); ?></td>
                        <td align="center">
                            <a href="<?php echo U("reconfirmdetail?id=$vo[id]&checklev=$checklev");?>">去审核</a>
                        </td>
