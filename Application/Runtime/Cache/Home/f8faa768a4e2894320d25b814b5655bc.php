    ...
    <div class="logo_content1">
        <div class="logo_ccon1">
            <div id="daniel_so" class="logo_enter1" style="border:none;float:left;">
                <?php if(count($msg) != 0): ?><div class="nav_tcon1" style="float:left;width:98%;" >
                    <div class="logotitle1">
                ...
                <textarea class="form-control"  style="width:60%"><?php if(is_array($msg)): foreach($msg as $key=>$vo): echo trim($vo['msg']).'__'.$vo['uname']."\r\n"; endforeach; endif; ?>
                </textarea>
                </div><?php endif; ?>
            ...
            <div class="nav_tcon1" style="float:left;width:80%;margin-left:100px;">
                ...
                <input type="submit" name="submit" class=" btn btn-success" value="合同原件彩色扫描件已上传，合同原件已给财务部" />
