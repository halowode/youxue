        ...
        <div class="logo_ccon1">
            <div class="logo_enter1" style="border:none;float:left;">
                <div class="login_box1">
                    <span class="login_title1" >银行号码修改：</span>
                    <input class="use_name" value="<?php echo ($data["bankno"]); ?>" id="bankno" name='bankno'  type="text" placeholder="银行号码修改" /><font style="color:#FF0000;line-height:40px;">&nbsp;</font>
                </div>
                <div class="login_box1">
                    <span class="login_title1" >银行余额：</span>
                    <input class="use_name" value="<?php echo ($data["total"]); ?>" id="total" name='total'  type="text" placeholder="银行账号余额" /><font style="color:#FF0000;line-height:40px;">&nbsp;</font>
                </div>
                <input type="hidden" name="id" value="<?php echo ($id); ?>"/>
                <input type="submit" name="submit" class="login_submit" value="提交" />
            </div>
        </div>
    </div>
</form>
