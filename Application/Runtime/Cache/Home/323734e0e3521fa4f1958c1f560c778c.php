...
<span class="cp_title" >关联审核</span>
<div class="table_con">
    <form method="get" action="">
        <table cellpadding="0" cellspacing="1">
            <tr>
                <td width="5%" align="center" class="tb_title">回款编号</td>
                <td width="10%" align="center" class="tb_title">关联合同</td>
            ...
            <?php if(!empty($data['list'])): if(is_array($data['list'])): foreach($data['list'] as $key=>$vo): ?><tr>
                        ...
                        <td align="center"><?php echo ($vo["btotal"]); ?></td>
                        <td align="center"><?php echo ($vo["btype"]); ?></td>
                        <td align="center"><?php echo ($vo["btime"]); ?></td>
                        <td align="center"><?php echo ($vo["bno"]); ?></td>
                        <td align="center">
                            <a  bid="<?php echo ($vo["id"]); ?>" data-toggle="modal" data-target="#myModal2" onclick="ddd(this)">
                                驳回
                            </a>
                            <a  bid="<?php echo ($vo["id"]); ?>" data-toggle="modal" data-target="#myModal" onclick="ddd(this)">
                                通过
                            </a>
                        </td>
