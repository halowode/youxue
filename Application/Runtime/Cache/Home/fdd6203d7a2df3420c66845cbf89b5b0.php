...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo U('index/bacstamp');?>" method="get">
...
<div class="logo_content1">
    <div class="logo_ccon1">
        <div class="logo_enter1" style="border:none;float:left;">
            <form id="billup" class="form-inline" action="<?php echo U('index/makestamp');?>" method="post">
                <!--
                ...
                <div class="login_box1">
                    ...
                    <input class="use_name form-control" value="<?php echo ($bill["adperiod"]); ?>" readonly id="adperiod" name='adperiod'  type="text" placeholder="" /><font style="color:#FF0000;line-height:40px;">&nbsp;</font>
                </div>
                <div class="login_box1">
                    <span class="login_title1" >推广位置：</span>
                    <input class="use_name form-control" value="<?php echo ($bill["adposition"]); ?>" readonly id="adposition" name='adposition'  type="text" placeholder="" /><font style="color:#FF0000;line-height:40px;">&nbsp;</font>
                </div>
                <div class="login_box1">
                    <span class="login_title1" >结算条款：</span>
                    <input class="use_name form-control" value="<?php echo ($bill["settleitem"]); ?>" readonly id="settleitem" name='settleitem'  type="text" placeholder="" /><font style="color:#FF0000;line-height:40px;">&nbsp;</font>
                </div>
                <div class="login_box1">
