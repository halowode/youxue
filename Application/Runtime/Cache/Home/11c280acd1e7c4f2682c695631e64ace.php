        ...
        <div class="logo_ccon1">
            <div class="logo_enter1" style="border:none;float:left;">
                ...
                <div class="login_box1">
                    ...
                    <input class="use_name  form-control" value="<?php echo ($contract["belong"]); ?>" readonly id="cbcomp" name='cbcomp'  type="text" placeholder="开票公司" /><font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="login_box1">
                    <span class="login_title1" >客户名称：</span>
                ...
                <div class="login_box1">
                    ...
                    <input class="use_name form-control" id="btotal" value="<?php echo ($bill["btotal"]); ?>" readonly  name='btotal'  type="text" placeholder="开票金额，填写数字" /><font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="nav_tcon1" style="float:left;width:98%;" >
                    <div class="logotitle1">
                ...
                <?php if($bill["provepic"] != ''): ?><div class="login_box1  daniel_hide">
                ...
                <div class="nav_tcon1" style="margin-left:160px;float:left;width:98%;">
                    <a class=" btn btn-success" bid="<?php echo ($bill["id"]); ?>" data-toggle="modal" data-target="#myModal3" onclick="ddds(this)">
                        审核通过
                    </a>
                    <a class="btn btn-danger" bid="<?php echo ($bill["id"]); ?>" data-toggle="modal" data-target="#myModal2" onclick="ddds(this)">
                        驳回申请
                    </a>
