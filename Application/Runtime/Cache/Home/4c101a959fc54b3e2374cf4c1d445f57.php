    ...
    <form method="get" action="">
        <table cellpadding="0" cellspacing="1">
            ...
            <?php if(!empty($data['list'])): if(is_array($data['list'])): foreach($data['list'] as $key=>$vo): ?><tr>
                        ...
                        <td align="center"><?php echo ($vo["cbcontent"]); ?></td>
                        <td align="center"> <?php echo number_format($vo['btotal'],2);?> </td>
                        <td align="center">
                            <?php if($vo["bstatus"] == 0): ?><span style="color:red">被驳回</span><?php endif; ?>
                            <?php if($vo["bstatus"] == 1): ?><span style="color:yellowgreen"><?php echo ($vo["ckuname"]); ?>初审中</span><?php endif; ?>
                            <?php if($vo["bstatus"] == 2): ?><span style="color:yellow"><?php echo ($vo["reckuname"]); ?>复审中</span><?php endif; ?>
                        ...
                        <td align="center">
                            <?php if($vo["bstatus"] == 0): ?><span style="color:red">
                                    <a href="<?php echo U("billedit?id=$vo[id]&cid=$vo[cid]");?>">查看并编辑</a>
                                </span><?php endif; ?>
                            <?php if($vo["bstatus"] == 1): ?><span style="color:red">
                                    <a href="<?php echo U("delbill?id=$vo[id]");?>">删除开票申请</a>
                                </span><?php endif; ?>
                        </td>
