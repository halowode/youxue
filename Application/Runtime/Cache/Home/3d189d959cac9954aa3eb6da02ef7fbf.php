        ...
        <div class="logo_ccon1">
            <div id="daniel_so" class="logo_enter1" style="border:none;float:left;">
                <div class="login_box1 form-group">
                    <span class="login_title1 col-sm-2 control-label">执行是否完成</span>
                    <select class="use_name form-control input-sm" name="done"  style="width:100px">
                        <option value="1"> 执行完成</option>
                        <option value="0"> 还会执行</option>
                    </select>
                ...
                <div class="login_box1 form-group" style="width:80%">
                    <span class="login_title1 col-sm-2 control-label">上传执行图片</span>
            ...
            <div class="nav_tcon1" style="float:left;width:80%;margin-left:100px;">
                ...
                <input type="submit" name="submit" class=" btn btn-success" value="执行" />
