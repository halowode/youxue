        ...
        <div class="logo_ccon1">
            <div class="logo_enter1" style="border:none;float:left;">
                ...
                <div class="login_box1">
                    ...
                    <input class="use_name" name='pname' id="pname"  type="text" placeholder="年份及项目名称如：2016华睿..." /><font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="login_box1">
                    <span class="login_title1" >项目简称：</span>
                    <input class="use_name" id="shortname" name='shortname'  type="text" placeholder="项目简称" /><font style="color:#FF0000;line-height:40px;">&nbsp;</font>
                </div>
                <div class="login_box1">
                    <span class="login_title1" >项目描述：</span>
                    <input class="use_name" id="total" name='descb'  type="text" placeholder="项目的有关描述" /><font style="color:#FF0000;line-height:40px;">&nbsp;</font>
                </div>
