        ...
        <div class="logo_ccon1">
            <div class="logo_enter1" style="border:none;float:left;">
                <div class="login_box1 form-group">
                    ...
                    <textarea class="form-control" style="margin-left: 100px;width:60%"><?php if(is_array($errmsg)): $i = 0; $__LIST__ = $errmsg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; echo $vo['msg'],'--'.$vo['uname'],"\r\n"; endforeach; endif; else: echo "" ;endif; ?>
                    </textarea>
                </div>
            ...
            <div id="daniel_so" class="logo_enter1" style="border:none;float:left;">
                ...
                <div class="login_box1 form-group">
                    ...
                    <select id="proj" class="use_name form-control input-xsm" name="pid"   style="width:200px">
                        ...
                        <?php if(is_array($pro)): $i = 0; $__LIST__ = $pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($data['pid']) == $vo["id"]): ?>selected=selected<?php endif; ?> > <?php echo ($vo["pname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="login_box1 form-group">
                    ...
                    <select id="checkid" class="use_name form-control input-xsm" name="checkuid"   style="width:200px">
                        <option value="">请选择</option>
                        <?php if(is_array($cusers)): $i = 0; $__LIST__ = $cusers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($data['checkuid']) == $vo["id"]): ?>selected=selected<?php endif; ?> > <?php echo ($vo["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="login_box1 form-group">
                    ...
                    <select id="con" class="use_name form-control input-xsm" name="cid"   style="width:200px">
                        <option value="0" <?php if(($data['cid']) == "0"): ?>selected=selected<?php endif; ?>>无销售合同</option>
                        <?php if(is_array($slc)): $i = 0; $__LIST__ = $slc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vs["id"]); ?>" <?php if(($data['cid']) == $vs["id"]): ?>selected=selected<?php endif; ?>><?php echo ($vs["cno"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="login_box1 form-group">
                    ...
                    <select id="cgid" class="use_name form-control input-xsm" name="cgid"   style="width:200px">
                        <option value="0" <?php if(($data['cgid']) == "0"): ?>selected=selected<?php endif; ?>>无采购合同</option>
                        <?php if(is_array($cgc)): $i = 0; $__LIST__ = $cgc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vc): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vc["id"]); ?>" <?php if(($data['cgid']) == $vc["id"]): ?>selected=selected<?php endif; ?>><?php echo ($vc["cno"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <font style="color:#FF0000;line-height:40px;">&nbsp;*</font>
                </div>
                <div class="login_box1 form-group" style="width:80%">
                    <span class="login_title1 col-sm-2 control-label" >备注</span>
                    <textarea class="use_name form-control"  name='remark'  type="text" placeholder="备注信息"><?php echo ($data["remark"]); ?></textarea>
                </div>
                <table id="d_table" class=" table table-bordered" style="margin-left:30px;margin-top:-20px">
                    <tr class="active">
                        <th>报销摘要</th>
                        <th>发生月份</th>
                        <?php if($rbtype == 0): ?><th>发生金额</th><?php endif; ?>
                        <th>申请金额</th>
                    </tr>
                    <?php if(is_array($reimdata)): $i = 0; $__LIST__ = $reimdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="info">
                        <td width="35%"><input class="form-control" name="ab[]" value="<?php echo ($vo["ab"]); ?>" type="text"/></td>
                        <td><input class="form-control" name="etime[]" value="<?php echo ($vo["etime"]); ?>" type="text" placeholder="格式：2016-06"/></td>
                        <?php if($rbtype == 0): ?><td><input class="form-control" name="etotal[]" value="<?php echo ($vo["etotal"]); ?>" type="text"/></td><?php endif; ?>
                        <td><input class="form-control" name="atotal[]" value="<?php echo ($vo["atotal"]); ?>" type="text"/></td>
                ...
                <?php if(is_array($pics)): $i = 0; $__LIST__ = $pics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bill): $mod = ($i % 2 );++$i;?><div class="login_box1" style="width:90%">
                        ...
                        <span class="daniel_icon"><img width="100" src="<?php echo ($bill['path']); ?>"></span>
                        <input type="hidden" name="pic[]" value="<?php echo ($bill["path"]); ?>"/>
            ...
            <div class="nav_tcon1" style="float:left;width:98%;">
                ...
                <input type="hidden" name="rbid" value="<?php echo ($data["rbid"]); ?>"/>
                <input type="hidden" name="rbno" value="<?php echo ($data["rbno"]); ?>"/>
                <?php if($rbtype == 0): ?><input style="margin-left:200px" type="submit"  class="login_submit btn btn-primary" value="申请报销" />
                    <?php else: ?>
                    <input style="margin-left:200px" type="submit"  class="login_submit btn btn-primary" value="申请借款" /><?php endif; ?>
            </div>
        </div>
    </div>
</form>
